...
app.service('apiService', ['$http', '$q', 'appSettings', function ($http, $q, appSettings) {
    ...
    var get = function (module, parameter) {
        ...
        $http.get(apiBase + module, { params: parameter }, { headers: { 'Content-Type': 'application/json','Cache-Control' : 'no-cache' } }).success(function (response) {
    ...
    var create = function (module, parameter) {
        ...
        $http.post(apiBase + module, parameter, { headers: { 'Content-Type': 'application/json','Cache-Control' : 'no-cache' } }).success(function (response) {
    ...
    var update = function (module, parameter) {
        ...
        $http.post(apiBase + module + '/' + parameter.id, parameter, { headers: { 'Content-Type': 'application/json','Cache-Control' : 'no-cache' } }).success(function (response) {
